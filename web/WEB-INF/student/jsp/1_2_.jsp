...
<div class="container">
    <div class="tranbox">
        ...
        <table class="table table-hover table-bordered" style="word-wrap:break-word;word-break:break-all;margin: 100px 0">
            ...
            <%-- 我写10的那里我觉得还应该增加人数 --%>
            <tbody>
            <c:forEach var="course" items="${requestScope.get('selectiveCourseList')}">
                <tr>
                    ...
                    <form action="${pageContext.request.contextPath}/StudentController/submitASelection2" method="get">
                    <td class="col-md-1">
                    ...
                    <td class="col-md-1">
                            <%-- 点击确认按钮之后重新回到这个界面，但是已经提交了信息
                        <a class="btn btn-default" type="submit"  onclick="tip1()" href="${pageContext.request.contextPath}/StudentController/toSelectSelectiveCourseDes/${course.getName()}">确认选课</a>
                     --%>
