...
<div class="container">
    <div class="tranbox">
        ...
        <table class="table table-hover table-bordered" style="word-wrap:break-word;word-break:break-all;margin: 100px 0">
            ...
            <%-- 我写10的那里我觉得还应该增加人数 --%>
            <tbody>
            <c:forEach var="course" items="${requestScope.get('peCourseList')}">
                <tr>
                    ...
                    <form action="${pageContext.request.contextPath}/StudentController/submitASelection3" method="get">
                    <td class="col-md-1">
                    ...
                    <td class="col-md-1">
                        ...
                        <a class="btn btn-default" type="submit"  onclick="tip1()" href="${pageContext.request.contextPath}/StudentController/toSelectPECourseDes/${course.getName()}">确认选课</a>
                    --%>
