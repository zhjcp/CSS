    ...
    <div style="height: 80px;width:100%">
        ...
        <div>
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                <c:forEach var="course" items="${requestScope.get('peCourseListUnique')}">
                    <tr>
                        <td class="col-md-4">${course.getName()}</td>

                        <td class="col-md-4"> ${course.getCredits()}</td>
                        <td class="col-md-4">
                            <a class="btn btn-default" href="${pageContext.request.contextPath}/StudentController/toSelectPECourseDes/${course.getName()}">查看详情</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
